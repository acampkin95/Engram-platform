...
PATTERNS = {
    ...
    ArtifactType.BITCOIN_ADDRESS: re.compile(r"\b(?:bc1|[13])[a-km-zA-HJ-NP-Z1-9]{25,62}\b"),
    ...
    ArtifactType.SOCIAL_HANDLE: re.compile(
        r"(?:(?:twitter|instagram|telegram|github|discord)\s*[:@]\s*|" r"@)([A-Za-z0-9_]{3,30})",
        re.IGNORECASE,
    ),
...
if __name__ == "__main__":
    ...
    types = None
    if args.types:
        types = [ArtifactType(t) for t in args.types if t in [e.value for e in ArtifactType]]
