...
def get_extraction_strategy():
    ...
    try:
        from crawl4ai_darkweb_osint.extraction.onion_strategy import OnionExtractionStrategy
    except ModuleNotFoundError:
...
def register_addon(app):
    ...
    app.include_router(discovery_router, prefix="/api/darkweb", tags=["darkweb-discovery"])
    app.include_router(extraction_router, prefix="/api/darkweb", tags=["darkweb-extraction"])
    app.include_router(analysis_router, prefix="/api/darkweb", tags=["darkweb-analysis"])
