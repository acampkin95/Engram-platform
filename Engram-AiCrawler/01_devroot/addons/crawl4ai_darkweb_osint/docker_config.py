...
if __name__ == "__main__":
    ...
    parser.add_argument("--tor-only", action="store_true", help="Generate Tor-only compose")
    parser.add_argument("--dockerfile", action="store_true", help="Generate Dockerfile snippet")
