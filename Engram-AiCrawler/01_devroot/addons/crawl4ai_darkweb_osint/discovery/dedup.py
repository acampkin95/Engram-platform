...
def deduplicate_results(
    ...
    for result in results:
        ...
        if is_duplicate:
            ...
            if duplicate_reason:
                duplicate_sources[duplicate_reason] = duplicate_sources.get(duplicate_reason, 0) + 1
        else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--hash", nargs=2, metavar=("TITLE", "DESC"), help="Compute content hash")
