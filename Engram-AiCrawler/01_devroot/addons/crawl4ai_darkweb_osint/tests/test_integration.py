...
class TestDiscovery:
    ...
    async def test_search_engines_defined(self):
        ...
        assert len(SEARCH_ENGINES) == 16, f"Expected 16 engines, got {len(SEARCH_ENGINES)}"
...
class TestAnalysis:
    ...
    def test_presets_defined(self):
        ...
        from crawl4ai_darkweb_osint.analysis.presets import PRESET_PROMPTS, AnalysisPreset
