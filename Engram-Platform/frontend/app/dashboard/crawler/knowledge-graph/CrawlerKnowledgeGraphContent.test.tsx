...
import CrawlerKnowledgeGraphContent from './CrawlerKnowledgeGraphContent';
...
test('renders CrawlerKnowledgeGraphContent without crashing', async () => {
  render(<CrawlerKnowledgeGraphContent />);
