...
export default function SignUpPage() {
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-void overflow-hidden">
      ...
      <div className="absolute top-1/4 -left-32 h-96 w-96 rounded-full bg-[#7C5CBF]/[0.04] blur-[128px]" />
      <div className="absolute bottom-1/4 -right-32 h-96 w-96 rounded-full bg-[#f2a93b]/[0.03] blur-[128px]" />
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl border border-white/[0.06] bg-white/[0.03] shadow-lg shadow-violet-500/10">
            <span className="font-[Syne] text-2xl font-bold text-[#7C5CBF]">E</span>
          </div>
          <h1 className="font-[Syne] text-2xl font-bold tracking-tight text-[#f0eef8]">
            Create your account
          </h1>
          <p className="mt-1 font-mono text-sm text-[#5c5878]">
            Get started with Engram Intelligence
          </p>
        </div>
